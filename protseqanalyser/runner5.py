...
def main():
    ...
    while True:
        ...
        for job in obj:
            ...
            with open('models/HHBlits/Datasets/WebRequests/Input/5_' + str(job.id) + '.fasta', 'w') as f:
                f.write(job.sequence)
            with open('models/PSIPRED/Datasets/WebRequests/Input/5_' + str(job.id) + '.fasta', 'w') as f:
                f.write(job.sequence)
            with open('models/PSI-BLAST/Datasets/WebRequests/Input/5_' + str(job.id) + '.fasta', 'w') as f:
                f.write(job.sequence)
